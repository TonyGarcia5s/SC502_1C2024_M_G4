...
if (isset($_POST["usr"]) && isset($_POST["pass"])) {
    ...
    $result = $mvcDatos->selectQuery("SELECT * FROM usuarios WHERE usuario=:usuario AND password=md5(:password) AND estado=1", array(':usuario' => $_POST["usr"], ':password' => $_POST["pass"]));
